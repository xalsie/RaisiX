...
<link rel="stylesheet" href="https://maxst.icons8.com/vue-static/landings/line-awesome/font-awesome-line-awesome/css/all.min.css">', '', 'appDashboard');
?>
   <!-- loader Start -->
   <div id="loading">
         ...
         <div class="row">
            <div class="col-lg-6">
               <ul class="list-inline mb-0">
                  <li class="list-inline-item"><a href="privacy-policy.html">Politique de confidentialité</a></li>
                  <li class="list-inline-item"><a href="terms-of-service.html">Conditions d'utilisation</a></li>
               </ul>
            </div>
            <div class="col-lg-6 text-right">Copyright 2022 <a href="#">RaisiX</a> All Rights Reserved.
            </div>
         </div>
      </div>
   </footer>
