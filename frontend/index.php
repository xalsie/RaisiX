               ...
               <div class="container-fluid position-relative h-100">
                  <div class="slider-inner h-100">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                           <a href="javascript:void(0);">
                              <div class="channel-logo" data-animation-in="fadeInLeft" data-delay-in="0.5">
                                 <img src="/frontend/assets/images/logo.png" class="c-logo" alt="raisix">
                              </div>
                           </a>
                           ...
                           <div class="d-flex align-items-center r-mb-23" data-animation-in="fadeInUp" data-delay-in="1.2">
                              <a href="show-details.php" class="btn btn-hover"><i class="fa fa-play me-2"
                     ...
                     <div class="trailor-video">
                        <a href="/frontend/assets/video/trailer.mp4" class="video-open playbtn">
                     ...
                     <div class="row align-items-center  h-100">
                        <div class="col-xl-6 col-lg-12 col-md-12">
                           ...
                           <div class="d-flex align-items-center r-mb-23" data-animation-in="fadeInUp" data-delay-in="1">
                              <a href="movie-details.php" class="btn btn-hover"><i class="fa fa-play me-2"
                                 aria-hidden="true"></i>Play Now</a>
                        ...
                        <ul class="favorites-slider list-inline  row p-0 mb-0">
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/favorite/01.jpg" class="img-fluid" alt="">
                                    </div>
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/favorite/02.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Last Race</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/favorite/03.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Boop Bitty</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/favorite/04.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Dino Land</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/favorite/05.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                        ...
                        <ul class="favorites-slider list-inline row p-0 mb-0">
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/upcoming/01.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                           ...
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/upcoming/02.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Last Night</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                                          <div class="badge badge-secondary p-1 me-2">22+</div>
                           ...
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/upcoming/03.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>1980</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                                          <div class="badge badge-secondary p-1 me-2">25+</div>
                           ...
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/upcoming/04.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Looters</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/upcoming/05.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Vugotronic</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                  ...
                  <div class="col-sm-12 overflow-hidden">
                     ...
                     <div class="topten-contens">
                        ...
                        <ul id="top-ten-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                           <li>
                              <a href="movie-details.php">
                              <img src="/frontend/assets/images/top-10/01.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.php">
                              <img src="/frontend/assets/images/top-10/02.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.php">
                              <img src="/frontend/assets/images/top-10/03.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.php">
                              <img src="/frontend/assets/images/top-10/04.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.php">
                              <img src="/frontend/assets/images/top-10/05.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.php">
                              <img src="/frontend/assets/images/top-10/06.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                        </ul>
                        ...
                        <ul class="list-inline favorites-slider row p-0 mb-0">
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/suggested/01.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Blood Block</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/suggested/02.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Mission Moon</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/suggested/03.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Unknown Land</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/suggested/04.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Friends</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="movie-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/suggested/05.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
            ...
            <div class="container-fluid h-100">
               <div class="row align-items-center justify-content-center h-100 parallaxt-details">
                  <div class="col-lg-4 r-mb-23">
                     <div class="text-left">
                        <a href="javascript:void(0);">
                        <img src="/frontend/assets/images/parallax/parallax-logo.png" class="img-fluid" alt="bailey">
                        </a>
                  ...
                  <div class="col-lg-8">
                     <div class="parallax-img">
                        <a href="movie-details.php">
                        	<img src="/frontend/assets/images/parallax/p1.jpg" class="img-fluid w-100" alt="bailey">
                        </a>
                     </div>
                  </div>
               </div>
                           ...
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="/frontend/assets/images/trending/01.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="/frontend/assets/images/trending/02.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="/frontend/assets/images/trending/03.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="/frontend/assets/images/trending/04.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="/frontend/assets/images/trending/05.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="/frontend/assets/images/trending/06.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                        </ul>
                        <ul id="trending-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(/frontend/assets/images/trending/01.jpg);">
                                       ...
                                       <div id="trending-data1" class="overview-tab tab-pane fade active show">
                                          <div class="trending-info align-items-center w-100 animated fadeInUp">
                                             ...
                                             <div class="d-flex align-items-center series mb-4">
                                                <a href="javascript:void(0);"><img src="/frontend/assets/images/trending/trending-label.png"
                                             ...
                                             <div class="p-btns">
                                                <div class="d-flex align-items-center p-0">
                                                   <a href="show-details.php" class="btn btn-hover me-2" tabindex="0"><i
                                                      class="fa fa-play me-2" aria-hidden="true"></i>Play Now</a>
                                       ...
                                       <div id="trending-data2" class="overlay-tab tab-pane fade">
                                          <div
                                             ...
                                             <a href="show-details.php" tabindex="0">
                                                <div class="channel-logo">
                                                   <img src="/frontend/assets/images/logo.png" class="c-logo" alt="stramit">
                                                </div>
                                             </a>
                                             <h1 class="trending-text big-title text-uppercase">the hero camp</h1>
                                                ...
                                                <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0">
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.php">
                                                         <img src="/frontend/assets/images/episodes/01.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.php">
                                                         <img src="/frontend/assets/images/episodes/02.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.php">
                                                         <img src="/frontend/assets/images/episodes/03.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.php">
                                                         <img src="/frontend/assets/images/episodes/04.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.php">
                                                         <img src="/frontend/assets/images/episodes/05.jpg" class="img-fluid" alt="">
                                                         </a>
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(/frontend/assets/images/trending/02.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(/frontend/assets/images/trending/03.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(/frontend/assets/images/trending/04.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(/frontend/assets/images/trending/05.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(/frontend/assets/images/trending/06.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                  ...
                  <div class="col-sm-12 overflow-hidden">
                     ...
                     <div class="tvthrillers-contens">
                        <ul class="favorites-slider list-inline row p-0 mb-0">
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-/frontend/assets/images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/tvthrillers/01.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/tvthrillers/02.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/tvthrillers/03.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Arrival 1999</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/tvthrillers/04.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Night Mare</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.php">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="/frontend/assets/images/tvthrillers/05.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
