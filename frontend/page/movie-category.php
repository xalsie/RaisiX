...
<!-- Mirrored from iqonic.design/themes/raisixnew/frontend/html/movie-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Sep 2020 20:04:39 GMT -->
<head>
   <!-- Required meta tags -->
   <meta charset="UTF-8">
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <meta http-equiv="X-UA-Compatible" content="ie=edge">
   <title>raisix - Responsive Bootstrap 4 Template</title>
   <!-- Favicon -->
                              ...
                              <div class="iq-sub-dropdown">
                                 <div class="iq-card shadow-none m-0">
                                    <div class="iq-card-body">
                                       <a href="#" class="iq-sub-card">
                                          <div class="media align-items-center">
                                             <img src="images/notify/thumb-1.jpg" class="img-fluid mr-3" alt="raisix" />
                                             <div class="media-body">
                                       ...
                                       <a href="#" class="iq-sub-card">
                                          <div class="media align-items-center">
                                             <img src="images/notify/thumb-2.jpg" class="img-fluid mr-3" alt="raisix" />
                                             <div class="media-body">
                                                <h6 class="mb-0 ">The Last Breath</h6>
                                                <small class="font-size-12">15 minutes ago</small>
                                             </div>
                                       ...
                                       <a href="#" class="iq-sub-card">
                                          <div class="media align-items-center">
                                             <img src="images/notify/thumb-3.jpg" class="img-fluid mr-3" alt="raisix" />
                                             <div class="media-body">
                                                <h6 class="mb-0 ">The Hero Camp</h6>
                                                <small class="font-size-12">1 hour ago</small>
                                             </div>
...
<!-- Mirrored from iqonic.design/themes/raisixnew/frontend/html/movie-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Sep 2020 20:04:54 GMT -->
</html>