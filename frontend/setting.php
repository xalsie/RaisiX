...
echo Header_HTML("Réglage du compte", "");
?>
            ...
            <div class="row">
                <div class="col-lg-4 mb-3">
                    <div class="sign-user_card text-center">
                        ...
                        <img ng-src="{{PreviewImage}}" src="/frontend/assets/images/user/{{settingMap.avatar}}" class="rounded-circle img-fluid d-block avatar-150 cover mx-auto mb-3" alt="Avatar user">
